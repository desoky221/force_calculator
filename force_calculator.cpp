...
void doubleprojection() {
    ...
    cin >> alpha;
    cout << "Enter the second angel and the axis\n"
    ...
    file << "\nF' = F" << Fcount + 1 << "cos(" << alpha << ") = " << Fprime << endl
         ...
         << "F" << axis3 << " = " << Fprime << " sin(" << peta << ") = " << Fprime * sin(peta * M_PI / 180) << endl;
}
...
void threeD() {
    ...
    if (missing == 1) {
        ...
        file << "\nto calculate the direction we are going to use these equations :"
                "\ntheta X = cos^-1(" << Fxtotal << "/" << resultant << ") = " << thetax <<
             "\ntheta Y = cos^-1(" << Fytotal << "/" << resultant << ") = " << thetay <<
             "\ntheta Z = cos^-1(" << Fztotal << "/" << resultant << ") = " << thetaz << endl;
...
void twoD() {
    ...
    if (missing == 1) {
        ...
        file << "to calculate the resultant and the direction :\n"
             ...
             << "theta = tan^-1(Fry/Frx) = " << "tan^-1(" << Fytotal << "/" << Fxtotal << ") = " << theta;
        ...
        magnitude = sqrt(pow(missingFY, 2) + pow(missingFX, 2));
        theta = atan(missingFY / missingFX);
        file << "now we could calculate the missing force using this equation :" << endl <<
             ...
             "magnitude = sqrt(Frx^2+Fry^2) = " << "sqrt(" << missingFX << "^2 + " << missingFY << "^2) = " << magnitude << endl
             << "theta = tan^-1(Fry/Frx) = " << "tan^-1(" << missingFY << "/" << Fxtotal << ") = " << theta;
        cout << "The Missing Force Is :" << endl << "{ Fx = " << missingFX << "  Fy = " << missingFY << " }"<<endl<<"magnitude of the force : "<< magnitude
             <<endl << "theta :"<<theta;
    }
...
int main() {
    ...
    cout << "==============================================================================\n";
    cout << "====================================Hello!====================================\n";
    cout << "===========Welcome To My Program For Solving Cartesian Coordinates===========\n";
    cout << "==============================================================================\n";
    cout << "==============================================================================\n";
    ...
    while (c) {
        ...
        if (choice1 == 2) {
            ...
            cout << "Invalid input. Please enter '2' for 2D or '3' for 3D." << endl;
        }
    }
